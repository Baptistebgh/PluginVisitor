...
public class VisitorSax extends DefaultHandler{
   ...
   public void characters(char[] ch, int start, int end) throws SAXException {	   
     ...
     //  System.out.println("Nombre de Xpages : " + compteur);
       ...
       else if(node.equals("daemon-class")){
    	   daemon=daemon+1;
    	   test[500+daemon-1]= new String(ch, start, end);
    	   System.out.println("Nom de la portlet n°" + daemon + ": "+test[500+daemon-1]);
    	   node="";
       }
       else if(node.equals("rbac-resource-type-class")){
    	   rbac=rbac+1;
